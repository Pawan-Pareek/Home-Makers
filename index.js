...
//database connection
try {
  const DB_STRING = process.env.DB_STRING || 'mongodb://localhost:27017/mydatabase';
  if (DB_STRING !== 'mongodb://localhost:27017/mydatabasmongodb+srv://don:Pawan@18@cluster0.forw98y.mongodb.net/e') {
